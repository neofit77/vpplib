...
class Operator(object):
    ...
    def operate_steps(self, baseload, steps):
        ...
        net_dict = {}
        index = pd.date_range(start=self.current_timestamp,
                              end=self.current_timestamp
                              + self.current_timestamp.freq*steps,
                              freq=self.current_timestamp.freq)
    ...
    def plot_results(self, results):
        ...
        results["trafo_loading_percent"].plot(
            figsize=(16, 9), title="trafo_loading_percent"
        )
        plt.show()
        results["line_loading_percent"].plot(
            figsize=(16, 9), title="line_loading_percent"
        )
        plt.show()
