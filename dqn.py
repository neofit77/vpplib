...
import environment9 as ems_env
...
#                target[0][action] = reward + self.gamma * np.amax(t)#maximize the discounted future reward based on the given state
